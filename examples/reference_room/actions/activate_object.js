...
function create() {
    ...
    const light_switch = map.createFromObjects('objects', 'light_switch', { key: 'light_switch' });
    const ceiling_light = map.createFromObjects('objects', 'ceiling_light', { key: 'light_off' });
